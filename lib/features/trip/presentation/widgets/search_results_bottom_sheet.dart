...
import 'package:uber_clone/features/trip/presentation/widgets/searched_place_card.dart';
          ...
          BlocConsumer<MapBloc, MapState>(
            listener: (context, state) {
              ...
              if (state.placeDetailsState ==RequestState.loaded) {
               ...
               context.read<MapBloc>().add(GetPlaceDirections(LatLng(state.placeDetails!.lat, state.placeDetails!.long)));
              }
